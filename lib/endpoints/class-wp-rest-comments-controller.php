...
class WP_REST_Comments_Controller extends WP_REST_Controller {
	...
	public function prepare_item_for_response( $comment, $request ) {
		$data = array(
			...
			'author_name'  => html_entity_decode($comment->comment_author),
			...
			'content'      => array(
				'rendered'     => html_entity_decode(apply_filters( 'comment_text', $comment->comment_content, $comment )),
				'raw'          => html_entity_decode($comment->comment_content),
			),
