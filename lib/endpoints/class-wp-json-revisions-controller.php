...
class WP_JSON_Revisions_Controller extends WP_JSON_Controller {
	...
	public function __construct( $parent_post_type ) {
		...
		$this->parent_controller = new WP_JSON_Posts_Controller( $parent_post_type );
	...
	public function register_routes() {
		...
		register_json_route( 'wp', '/' . $this->parent_base . '/(?P<parent_id>[\d]+)/revisions', array(
		...
		register_json_route( 'wp', '/' . $this->parent_base . '/(?P<parent_id>[\d]+)/revisions/(?P<id>[\d]+)', array(
			array(
				'methods'         => WP_JSON_Server::READABLE,
		...
		register_json_route( 'wp', '/' . $this->parent_base . '/revisions/schema', array(
			'methods'         => WP_JSON_Server::READABLE,
	...
	/**
	 * Prepare the revision for the JSON response
	 *
