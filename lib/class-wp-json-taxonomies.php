...
class WP_JSON_Taxonomies {
	...
	public function register_routes( $routes ) {
		$tax_routes = array(
			'/posts/types/(?P<type>[a-z0-9-_]+)/taxonomies' => array(
				array( array( $this, 'get_taxonomies_for_type' ), WP_JSON_Server::READABLE | WP_JSON_Server::HIDDEN_ENDPOINT ),
			),
			'/posts/types/(?P<type>[a-z0-9-_]+)/taxonomies/(?P<taxonomy>[a-z0-9-_]+)' => array(
				array( array( $this, 'get_taxonomy' ),   WP_JSON_Server::READABLE | WP_JSON_Server::HIDDEN_ENDPOINT ),
			),
			'/posts/types/(?P<type>[a-z0-9-_]+)/taxonomies/(?P<taxonomy>[a-z0-9-_]+)/terms' => array(
				array( array( $this, 'get_terms' ),      WP_JSON_Server::READABLE | WP_JSON_Server::HIDDEN_ENDPOINT ),
			),
			'/posts/types/(?P<type>[a-z0-9-_]+)/taxonomies/(?P<taxonomy>[a-z0-9-_]+)/terms/(?P<term>[a-z0-9-_]+)' => array(
			...
			'/taxonomies/(?P<taxonomy>[a-z0-9-_]+)' => array(
				array( array( $this, 'get_taxonomy_object' ), WP_JSON_Server::READABLE ),
			),
			'/taxonomies/(?P<taxonomy>[a-z0-9-_]+)/terms' => array(
				array( array( $this, 'get_taxonomy_terms' ), WP_JSON_Server::READABLE ),
			),
			'/taxonomies/(?P<taxonomy>[a-z0-9-_]+)/terms/(?P<term>[a-z0-9-_]+)' => array(
