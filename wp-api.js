	...
	wp.api.models.Revision = wp.api.models.Post.extend(
		/** @lends Revision.prototype */
		{
			...
			url: function() {
				...
				return WP_API_Settings.root + '/wp/v2/posts/' + parent_id + '/revisions/' + id;
			},
...
(function( wp, WP_API_Settings, Backbone, _, window, undefined ) {
	...
	wp.api.collections.Comments = BaseCollection.extend(
		/** @lends Comments.prototype */
		{
			 ...
			 */
			url: function() {
				return WP_API_Settings.root + '/wp/v2/posts/' + this.post + '/comments';
			}
		}
	);
	...
	wp.api.collections.Terms = BaseCollection.extend(
		/** @lends Terms.prototype */
		{
			 ...
			 */
			url: function() {
				return WP_API_Settings.root + '/wp/v2/posts/types/' + this.type + '/taxonomies/' + this.taxonomy + '/terms/';
			}
		}
	);
